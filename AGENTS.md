...
Hospital Management System - Microservices architecture với Node.js/TypeScript backend, Next.js frontend, và Supabase database. Hệ thống quản lý bệnh viện hoàn chỉnh với 11 microservices, authentication, real-time features, và HIPAA compliance.
...
3005  - Department Service
3006  - Receptionist Service
