 ...
 * Gateway service for PayOS payment integration
 * 
 * @author Hospital Management Team
 * @version 2.0.0
 * @compliance Clean Architecture, PayOS API Integration, Vietnamese Healthcare
 */
...
/**
 * PayOSGatewayService
 * Infrastructure service for PayOS payment gateway integration
 */
