 ...
 */
export const validateDateFormat = (req: Request, res: Response, next: NextFunction): void => {
...
export const validateAvailabilityQuery = (req: Request, res: Response, next: NextFunction): void => {
  ...
  if (appointment_type) {
    const validTypes = ['consultation', 'follow_up', 'emergency', 'routine_checkup'];
 ...
 */
export const validateCheckAvailabilityBody = (req: Request, res: Response, next: NextFunction): void => {
  ...
  if (requestDate < today) {
    logger.warn('Availability check for past date', { date, today: today.toISOString().split('T')[0] });
 ...
 */
export const validateWeekStartDate = (req: Request, res: Response, next: NextFunction): void => {
 ...
 */
export const logAvailabilityRequest = (req: Request, res: Response, next: NextFunction): void => {
